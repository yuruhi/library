...
data:
  ...
  bundledCode: "#line 2 \"template/template.cpp\"\n#include <bits/stdc++.h>\n#line\
    ...
    \ operator[](const pair<int, int>& nm) const {\n\t\treturn Read2DVectorHelper(nm);\n\
    ...
    \ > 0) {\n\t\tif (n & 1)\n\t\t\tr = r * a % m, n--;\n\t\telse\n\t\t\ta = a * a\
    \ % m, n /= 2;\n\t}\n\treturn r;\n}\nnamespace internal {\n\ttemplate <class T,\
    \ size_t N> auto make_vector(vector<int>& sizes, const T& init) {\n\t\tif constexpr\
