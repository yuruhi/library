...
data:
  ...
  bundledCode: "#line 1 \"test/Geometric_closest_pair.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_5_A\"\n#define\
  ...
  verifiedWith: []
documentation_of: test/Geometric_closest_pair.test.cpp
layout: document
redirect_from:
- /verify/test/Geometric_closest_pair.test.cpp
- /verify/test/Geometric_closest_pair.test.cpp.html
