...
data:
  ...
  bundledCode: "#line 1 \"test/Ruby_Min_Max_Sum.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/lesson/2/ITP1/all/ITP1_4_D\"\
    ...
    \ T& val) {\n\tcontiner << val;\n\treturn continer;\n}\n#line 5 \"test/Ruby_Min_Max_Sum.test.cpp\"\
    \nusing namespace std;\n\nint main() {\n\tcin.tie(nullptr);\n\tios_base::sync_with_stdio(false);\n\
    \n\tint n;\n\tcin >> n;\n\tvector<long long> a(n);\n\tfor (auto& i : a) cin >>\
    \ i;\n\tcout << (a | Min) << ' ' << (a | Max) << ' ' << (a | Sum) << '\\n';\n\
    }\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/lesson/2/ITP1/all/ITP1_4_D\"\
  ...
  verifiedWith: []
documentation_of: test/Ruby_Min_Max_Sum.test.cpp
layout: document
redirect_from:
- /verify/test/Ruby_Min_Max_Sum.test.cpp
- /verify/test/Ruby_Min_Max_Sum.test.cpp.html
