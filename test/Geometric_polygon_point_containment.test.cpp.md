...
data:
  ...
  bundledCode: "#line 1 \"test/Geometric_polygon_point_containment.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_3_C\"\
    ...
    \ abs((a - b).rotation(-(c - b).angle()).angle());\n\t}\n\n\tLD distance(const\
    ...
    }\n\t}\n\n}  // namespace Geometric\n#line 5 \"test/Geometric_polygon_point_containment.test.cpp\"\
    \nusing namespace std;\n\nint main() {\n\tint n, q;\n\tcin >> n;\n\tGeometric::Polygon\
    \ p(n);\n\tcin >> p;\n\tcin >> q;\n\twhile (q--) {\n\t\tGeometric::Vec2 v;\n\t\
  ...
  requiredBy: []
  timestamp: '2020-11-03 10:46:54+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/Geometric_polygon_point_containment.test.cpp
layout: document
redirect_from:
- /verify/test/Geometric_polygon_point_containment.test.cpp
- /verify/test/Geometric_polygon_point_containment.test.cpp.html
