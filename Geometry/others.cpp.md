...
data:
  ...
  bundledCode: "#line 2 \"Geometry/Geometric.hpp\"\n#include <iostream>\n#include\
    ...
    \ TriangleArea(v1.distance(v2), v1.distance(v3), v2.distance(v3));\n\t}\n\n} \
    \ // namespace Geometric\n"
  code: "#pragma once\n#include \"./Geometric.hpp\"\n#include \"./Vec2.hpp\"\n\nnamespace\
    \ Geometric {\n\n\tLD TriangleArea(LD a, LD b, LD c) {\n\t\tLD s = (a + b + c)\
    \ / 2;\n\t\treturn sqrt(s * (s - a) * (s - b) * (s - c));\n\t}\n\tLD TriangleArea(const\
...
documentation_of: Geometry/others.cpp
layout: document
redirect_from:
- /library/Geometry/others.cpp
- /library/Geometry/others.cpp.html
