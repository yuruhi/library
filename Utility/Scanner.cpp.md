...
data:
  ...
  bundledCode: "#line 2 \"Utility/Scanner.cpp\"\n#include <iostream>\n#include <vector>\n\
    ...
    \ <size_t N = 0, class T> void column_impl(T& t) const {\n\t\tif constexpr (N\
